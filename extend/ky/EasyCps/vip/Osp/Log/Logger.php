...
namespace ky\EasyCps\Vip\Osp\Log;
...
class Logger
{
    ...
    {
        Logger::$LOG_PATH = \ky\EasyCps\Vip\Osp\Util\PathUtil::getRootPath() . "/osp-log/";
    ...
    public static function error($msg, $e)
    {
        ...
        if (Logger::$LOG_LEVEL <= Logger::$LOG_LEVEL_ERROR) {
            if ($e instanceof \ky\EasyCps\Vip\Osp\Exception\OspException) {
