    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            if ("storeInfo" == $schemeField) {
                ...
                $this->storeInfo = new \ky\EasyCps\Vip\Request\StoreInfo();
            ...
            if ("commentsInfo" == $schemeField) {
                ...
                $this->commentsInfo = new \ky\EasyCps\Vip\Request\GoodsCommentsInfo();
            ...
            if ("storeServiceCapability" == $schemeField) {
                ...
                $this->storeServiceCapability = new \ky\EasyCps\Vip\Request\StoreServiceCapability();
            ...
            if ($needSkip) {
                ...
                \ky\EasyCps\Vip\Osp\Protocol\ProtocolUtil::skip($input);
            }
