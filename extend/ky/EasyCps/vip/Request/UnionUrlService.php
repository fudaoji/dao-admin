...
interface UnionUrlServiceIf
{
    ...
    public function vipLinkCheck(\ky\EasyCps\Vip\Request\VipLinkCheckReq $vipLinkCheckReq);

    public function vipLinkCheckWithOuth(\ky\EasyCps\Vip\Request\VipLinkCheckReq $vipLinkCheckReq);

}

class _UnionUrlServiceClient extends \ky\EasyCps\Vip\Osp\Base\OspStub implements \ky\EasyCps\Vip\Request\UnionUrlServiceIf
{
    ...
    public function send_genByGoodsId($goodsIdList, $chanTag, $requestId)
    {
        ...
        $args = new \ky\EasyCps\Vip\Request\UnionUrlService_genByGoodsId_args();
    ...
    public function recv_genByGoodsId()
    {
        ...
        $result = new \ky\EasyCps\Vip\Request\UnionUrlService_genByGoodsId_result();
    ...
    public function send_genByGoodsIdWithOauth($goodsIdList, $chanTag, $requestId, $statParam)
    {
        ...
        $args = new \ky\EasyCps\Vip\Request\UnionUrlService_genByGoodsIdWithOauth_args();
    ...
    public function recv_genByGoodsIdWithOauth()
    {
        ...
        $result = new \ky\EasyCps\Vip\Request\UnionUrlService_genByGoodsIdWithOauth_result();
        $this->receive_base($result);
        if ($result->success !== null) {
    ...
    public function send_genByVIPUrl($urlList, $chanTag, $requestId)
    {
        ...
        $args = new \ky\EasyCps\Vip\Request\UnionUrlService_genByVIPUrl_args();
    ...
    public function recv_genByVIPUrl()
    {
        ...
        $result = new \ky\EasyCps\Vip\Request\UnionUrlService_genByVIPUrl_result();
        $this->receive_base($result);
        if ($result->success !== null) {
    ...
    public function send_genByVIPUrlWithOauth($urlList, $chanTag, $requestId)
    {
        ...
        $args = new \ky\EasyCps\Vip\Request\UnionUrlService_genByVIPUrlWithOauth_args();
    ...
    public function recv_genByVIPUrlWithOauth()
    {
        ...
        $result = new \ky\EasyCps\Vip\Request\UnionUrlService_genByVIPUrlWithOauth_result();
        $this->receive_base($result);
        if ($result->success !== null) {
    ...
    public function send_healthCheck()
    {
        ...
        $args = new \ky\EasyCps\Vip\Request\UnionUrlService_healthCheck_args();
    ...
    public function recv_healthCheck()
    {
        ...
        $result = new \ky\EasyCps\Vip\Request\UnionUrlService_healthCheck_result();
        $this->receive_base($result);
        if ($result->success !== null) {
    ...
    public function send_vipLinkCheck(\ky\EasyCps\Vip\Request\VipLinkCheckReq $vipLinkCheckReq)
    {

        $this->initInvocation("vipLinkCheck");
        $args = new \ky\EasyCps\Vip\Request\UnionUrlService_vipLinkCheck_args();
    ...
    public function recv_vipLinkCheck()
    {
        ...
        $result = new \ky\EasyCps\Vip\Request\UnionUrlService_vipLinkCheck_result();
        $this->receive_base($result);
        if ($result->success !== null) {
    ...
    public function send_vipLinkCheckWithOuth(\ky\EasyCps\Vip\Request\VipLinkCheckReq $vipLinkCheckReq)
    {

        $this->initInvocation("vipLinkCheckWithOuth");
        $args = new \ky\EasyCps\Vip\Request\UnionUrlService_vipLinkCheckWithOuth_args();
    ...
    public function recv_vipLinkCheckWithOuth()
    {
        ...
        $result = new \ky\EasyCps\Vip\Request\UnionUrlService_vipLinkCheckWithOuth_result();
        $this->receive_base($result);
        if ($result->success !== null) {
...
class UnionUrlService_vipLinkCheck_args
{
    ...
    public function read($input)
    {
        ...
        if (true) {
            ...
            $this->vipLinkCheckReq = new \ky\EasyCps\Vip\Request\VipLinkCheckReq();
...
class UnionUrlService_genByGoodsId_result
{
    ...
    public function read($input)
    {
        ...
        if (true) {
            ...
            $this->success = new \ky\EasyCps\Vip\Request\UrlGenResponse();
...
class UnionUrlService_vipLinkCheck_result
{
    ...
    public function read($input)
    {
        ...
        if (true) {
            ...
            $this->success = new \ky\EasyCps\Vip\Request\VipLinkCheckResp();
            $this->success->read($input);
