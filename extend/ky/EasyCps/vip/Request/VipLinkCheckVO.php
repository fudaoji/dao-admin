...
class VipLinkCheckVO
{
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            if ("linkType" == $schemeField) {
                ...
                $names = \ky\EasyCps\Vip\Request\VipLinkTypeEnum::$__names;
                $name = null;
    ...
    public function write($output)
    {
        ...
        if ($this->linkType !== null) {
            ...
            $em = new \ky\EasyCps\Vip\Request\VipLinkTypeEnum;
            $output->writeString(\ky\EasyCps\Vip\Request\VipLinkTypeEnum::$__names[$this->linkType]);
