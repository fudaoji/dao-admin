...
class UnionOrderServiceClient
{
    ...
    private static function regis()
    {
        ...
        $path = \ky\EasyCps\Vip\Osp\Util\PathUtil::getRootPath();
        $nsLoader = new \ky\EasyCps\Vip\Osp\ClassLoader\ClassLoader ();
    ...
    public static function getService()
    {
        ...
        $ctx = \ky\EasyCps\Vip\Osp\Context\InvocationContextFactory::getInstance();
        ...
        return new \ky\EasyCps\Vip\Request\UnionOrderServiceHelper();
    }
